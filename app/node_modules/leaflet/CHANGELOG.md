...
- Ensure that `latLngsToCoords()` does not return references passed to it ([#7344](https://github.com/Leaflet/Leaflet/pull/7344) by [@marlo22](https://github.com/marlo22%5D))
...
- Improve accessibility of popup close button ([#7908](https://github.com/Leaflet/Leaflet/pull/7908%5D), by [@Malvoz](https://github.com/Malvoz))
