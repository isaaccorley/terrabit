...
//#endregion
//#region node_modules/apache-arrow/util/utf8.mjs
...
//#endregion
//#region node_modules/apache-arrow/util/compat.mjs
...
//#endregion
//#region node_modules/apache-arrow/util/buffer.mjs
/** @ignore */
...
function* toArrayBufferViewIterator(ArrayCtor, source) {
	...
	yield* pump$1((function* (it) {
		...
		while (!r.done);
	})((typeof source === "string" ? wrap(source) : ArrayBuffer.isView(source) ? wrap(source) : source instanceof ArrayBuffer ? wrap(source) : source instanceof SharedArrayBuf ? wrap(source) : !isIterable(source) ? wrap(source) : source)[Symbol.iterator]()));
...
function toArrayBufferViewAsyncIterator(ArrayCtor, source) {
	return __asyncGenerator(this, arguments, function* toArrayBufferViewAsyncIterator_1() {
		if (isPromise(source)) return yield __await(yield __await(yield* __asyncDelegator(__asyncValues(toArrayBufferViewAsyncIterator(ArrayCtor, yield __await(source))))));
		const wrap = function(x) {
		...
		})((typeof source === "string" ? wrap(source) : ArrayBuffer.isView(source) ? wrap(source) : source instanceof ArrayBuffer ? wrap(source) : source instanceof SharedArrayBuf ? wrap(source) : isIterable(source) ? emit(source) : !isAsyncIterable(source) ? wrap(source) : source)[Symbol.asyncIterator]())))));
...
//#endregion
//#region node_modules/apache-arrow/io/adapters.mjs
/** @ignore */
...
function* fromIterable(source) {
	...
	function byteRange() {
		if (cmd === "peek") return joinUint8Arrays(buffers, size)[0];
	...
	return __asyncGenerator(this, arguments, function* fromNodeStream_1() {
		...
		try {
			...
			do {
				...
				if (!(done = event === "end")) {
					if (!Number.isFinite(size - bufferLength)) buffer = toUint8Array(stream["read"]());
					else {
						buffer = toUint8Array(stream["read"](size - bufferLength));
						if (buffer.byteLength < size - bufferLength) buffer = toUint8Array(stream["read"]());
					}
...
var ByteBuffer$2 = class ByteBuffer$2 {
	/**
...
//#endregion
//#region node_modules/flatbuffers/mjs/builder.js
var Builder$3 = class Builder$3 {
	/**
	...
	*/
	prep(size, additional_bytes) {
		...
		while (this.space < align_size + size + additional_bytes) {
			...
			this.bb = Builder$3.growByteBuffer(this.bb);
...
//#endregion
//#region node_modules/apache-arrow/fb/body-compression-method.mjs
/**
...
//#endregion
//#region node_modules/apache-arrow/fb/compression-type.mjs
var CompressionType;
...
//#endregion
//#region node_modules/apache-arrow/fb/body-compression.mjs
/**
* Optional compression for the memory buffers constituting IPC message
* bodies. Intended for use with RecordBatch but could be used for other
* message types
*/
var BodyCompression = class BodyCompression {
	constructor() {
		this.bb = null;
		this.bb_pos = 0;
	}
...
//#endregion
//#region node_modules/apache-arrow/fb/buffer.mjs
/**
* ----------------------------------------------------------------------
...
//#endregion
//#region node_modules/apache-arrow/fb/field-node.mjs
/**
* ----------------------------------------------------------------------
...
//#endregion
//#region node_modules/apache-arrow/fb/record-batch.mjs
/**
* A data header describing the shared memory layout of a "record" or "row"
* batch. Some systems call this a "row batch" internally and others a "record
* batch".
*/
var RecordBatch$2 = class RecordBatch$2 {
	constructor() {
		this.bb = null;
		this.bb_pos = 0;
	}
...
//#endregion
//#region node_modules/apache-arrow/fb/dictionary-batch.mjs
/**
...
* flag
*/
var DictionaryBatch$1 = class DictionaryBatch$1 {
	constructor() {
		this.bb = null;
		this.bb_pos = 0;
	}
...
//#endregion
//#region node_modules/apache-arrow/fb/endianness.mjs
/**
* ----------------------------------------------------------------------
...
//#endregion
//#region node_modules/apache-arrow/fb/dictionary-kind.mjs
/**
* ----------------------------------------------------------------------
...
//#endregion
//#region node_modules/apache-arrow/fb/int.mjs
var Int = class Int {
	constructor() {
		this.bb = null;
		this.bb_pos = 0;
...
//#endregion
//#region node_modules/apache-arrow/fb/dictionary-encoding.mjs
var DictionaryEncoding = class DictionaryEncoding {
	constructor() {
		this.bb = null;
		this.bb_pos = 0;
	}
...
//#endregion
//#region node_modules/apache-arrow/fb/key-value.mjs
/**
* ----------------------------------------------------------------------
* user defined key value pairs to add custom metadata to arrow
* key namespacing is the responsibility of the user
*/
var KeyValue = class KeyValue {
	constructor() {
		this.bb = null;
		this.bb_pos = 0;
	}
...
//#endregion
//#region node_modules/apache-arrow/fb/binary.mjs
/**
* Opaque binary data
*/
var Binary$1 = class Binary$1 {
	constructor() {
		this.bb = null;
		this.bb_pos = 0;
	}
...
//#endregion
//#region node_modules/apache-arrow/fb/bool.mjs
var Bool$1 = class Bool$1 {
	constructor() {
		this.bb = null;
		this.bb_pos = 0;
	}
...
//#endregion
//#region node_modules/apache-arrow/fb/date.mjs
/**
...
//#endregion
//#region node_modules/apache-arrow/fb/decimal.mjs
/**
...
//#endregion
//#region node_modules/apache-arrow/fb/duration.mjs
var Duration$1 = class Duration$1 {
	constructor() {
		this.bb = null;
		this.bb_pos = 0;
	}
	...
	static getRootAsDuration(bb, obj) {
		return (obj || new Duration$1()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
	}
	...
	static createDuration(builder, unit) {
		Duration$1.startDuration(builder);
		Duration$1.addUnit(builder, unit);
		return Duration$1.endDuration(builder);
	}
};
//#endregion
//#region node_modules/apache-arrow/fb/fixed-size-binary.mjs
var FixedSizeBinary$1 = class FixedSizeBinary$1 {
	constructor() {
		this.bb = null;
		this.bb_pos = 0;
	}
...
//#endregion
//#region node_modules/apache-arrow/fb/fixed-size-list.mjs
var FixedSizeList$1 = class FixedSizeList$1 {
	constructor() {
		this.bb = null;
		this.bb_pos = 0;
	}
...
//#endregion
//#region node_modules/apache-arrow/fb/floating-point.mjs
var FloatingPoint = class FloatingPoint {
	constructor() {
		this.bb = null;
		this.bb_pos = 0;
	}
...
//#endregion
//#region node_modules/apache-arrow/fb/interval.mjs
...
//#endregion
//#region node_modules/apache-arrow/fb/large-binary.mjs
/**
* Same as Binary, but with 64-bit offsets, allowing to represent
* extremely large data values.
*/
var LargeBinary$1 = class LargeBinary$1 {
	constructor() {
		this.bb = null;
		this.bb_pos = 0;
	}
	...
	static getRootAsLargeBinary(bb, obj) {
		return (obj || new LargeBinary$1()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
	}
	...
	static createLargeBinary(builder) {
		LargeBinary$1.startLargeBinary(builder);
		return LargeBinary$1.endLargeBinary(builder);
	}
};
//#endregion
//#region node_modules/apache-arrow/fb/large-utf8.mjs
/**
* Same as Utf8, but with 64-bit offsets, allowing to represent
* extremely large data values.
*/
var LargeUtf8$1 = class LargeUtf8$1 {
	constructor() {
		this.bb = null;
		this.bb_pos = 0;
	}
	...
	static getRootAsLargeUtf8(bb, obj) {
		return (obj || new LargeUtf8$1()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
	}
	...
	static createLargeUtf8(builder) {
		LargeUtf8$1.startLargeUtf8(builder);
		return LargeUtf8$1.endLargeUtf8(builder);
	}
};
//#endregion
//#region node_modules/apache-arrow/fb/list.mjs
var List$1 = class List$1 {
	constructor() {
		this.bb = null;
		this.bb_pos = 0;
	}
...
//#endregion
//#region node_modules/apache-arrow/fb/map.mjs
/**
...
//#endregion
//#region node_modules/apache-arrow/fb/null.mjs
/**
* These are stored in the flatbuffer in the Type union below
*/
var Null$1 = class Null$1 {
	constructor() {
		this.bb = null;
		this.bb_pos = 0;
	}
...
//#endregion
//#region node_modules/apache-arrow/fb/struct-.mjs
/**
* A Struct_ in the flatbuffer metadata is the same as an Arrow Struct
* (according to the physical memory layout). We used Struct_ here as
* Struct is a reserved word in Flatbuffers
*/
var Struct_ = class Struct_ {
	constructor() {
		this.bb = null;
		this.bb_pos = 0;
	}
...
//#endregion
//#region node_modules/apache-arrow/fb/time.mjs
/**
...
//#endregion
//#region node_modules/apache-arrow/fb/timestamp.mjs
/**
...
//#endregion
//#region node_modules/apache-arrow/fb/union.mjs
/**
...
//#endregion
//#region node_modules/apache-arrow/fb/utf8.mjs
/**
* Unicode with UTF-8 encoding
*/
var Utf8$1 = class Utf8$1 {
	constructor() {
		this.bb = null;
		this.bb_pos = 0;
	}
...
//#endregion
//#region node_modules/apache-arrow/fb/type.mjs
/**
* ----------------------------------------------------------------------
...
//#endregion
//#region node_modules/apache-arrow/fb/field.mjs
/**
* ----------------------------------------------------------------------
* A field represents a named column in a record / row batch or child of a
* nested type.
*/
var Field$1 = class Field$1 {
	constructor() {
		this.bb = null;
		this.bb_pos = 0;
	}
...
//#endregion
//#region node_modules/apache-arrow/fb/schema.mjs
/**
* ----------------------------------------------------------------------
* A Schema describes the columns in a row batch
*/
var Schema$1 = class Schema$1 {
	constructor() {
		this.bb = null;
		this.bb_pos = 0;
	}
...
//#endregion
//#region node_modules/apache-arrow/fb/message-header.mjs
/**
* ----------------------------------------------------------------------
...
//#endregion
//#region node_modules/apache-arrow/util/pretty.mjs
...
//#endregion
//#region node_modules/apache-arrow/util/bn.mjs
/** @ignore */
var isArrowBigNumSymbol = Symbol.for("isArrowBigNum");
/** @ignore */
function BigNum(x, ...xs) {
	if (xs.length === 0) return Object.setPrototypeOf(toArrayBufferView(this["TypedArray"], x), this.constructor.prototype);
...
/** @ignore */
var Int64$1 = class extends Int_ {
	constructor() {
		super(true, 64);
	}
	get ArrayType() {
...
/** @ignore */
var Uint64$1 = class extends Int_ {
	constructor() {
		super(false, 64);
	}
	get ArrayType() {
...
//#endregion
//#region node_modules/apache-arrow/visitor.mjs
var Visitor = class {
...
function getVisitFn(visitor, node, throwIfNotFound = true) {
	...
	if (typeof node === "string" && node in Type) return getVisitFnByTypeId(visitor, Type[node], throwIfNotFound);
	if (node && node instanceof DataType) return getVisitFnByTypeId(visitor, inferDType(node), throwIfNotFound);
	if ((node === null || node === void 0 ? void 0 : node.type) && node.type instanceof DataType) return getVisitFnByTypeId(visitor, inferDType(node.type), throwIfNotFound);
...
//#endregion
//#region node_modules/apache-arrow/util/math.mjs
...
//#endregion
//#region node_modules/apache-arrow/visitor/set.mjs
/** @ignore */
...
var setAnyFloat = (data, index, value) => {
	switch (data.type.precision) {
		case Precision.HALF: return setFloat16(data, index, value);
		case Precision.SINGLE:
		case Precision.DOUBLE: return setFloat(data, index, value);
	}
};
/** @ignore */
...
/** @ignore */
var instance$6 = new SetVisitor();
//#endregion
//#region node_modules/apache-arrow/row/struct.mjs
...
var StructRow = class {
	...
	toJSON() {
		...
		const json = {};
		for (let j = -1, n = keys.length; ++j < n;) json[keys[j].name] = instance$5.visit(parent.children[j], i);
		return json;
	}
	toString() {
	...
	next() {
		...
		if (i < this.numChildren) {
			...
			return {
				...
				value: [this.childFields[i].name, instance$5.visit(this.children[i], this.rowIndex)]
			};
		}
		return {
			done: true,
...
var StructRowProxyHandler = class {
	...
	getOwnPropertyDescriptor(row, key) {
		if (row[kParent].type.children.findIndex((f) => f.name === key) !== -1) return {
			writable: true,
			enumerable: true,
			configurable: true
		};
...
//#endregion
//#region node_modules/apache-arrow/visitor/get.mjs
/** @ignore */
...
/** @ignore */
var getBool$1 = ({ offset, values }, index) => {
	const idx = offset + index;
...
var getList = (data, index) => {
	...
	return new Vector([children[0].slice(begin, end - begin)]);
};
/** @ignore */
...
var getFixedSizeList = (data, index) => {
	...
	return new Vector([children[0].slice(index * stride, stride)]);
};
...
/** @ignore */
var instance$5 = new GetVisitor();
//#endregion
//#region node_modules/apache-arrow/row/map.mjs
/** @ignore */ var kKeys = Symbol.for("keys");
/** @ignore */ var kVals = Symbol.for("vals");
/** @ignore */ var kKeysAsStrings = Symbol.for("kKeysAsStrings");
/** @ignore */ var _kKeysAsStrings = Symbol.for("_kKeysAsStrings");
var MapRow = class {
	constructor(slice) {
	...
	toJSON() {
		...
		const json = {};
		for (let i = -1, n = keys.length; ++i < n;) json[keys.get(i)] = instance$5.visit(vals, i);
		return json;
	}
	toString() {
		return `{${[...this].map(([key, val]) => `${valueToString(key)}: ${valueToString(val)}`).join(", ")}}`;
...
var MapRowIterator = class {
	...
	next() {
		...
		return {
			...
			value: [this.keys.get(i), instance$5.visit(this.vals, i)]
		};
	}
};
/** @ignore */
var MapRowProxyHandler = class {
	...
	getOwnPropertyDescriptor(row, key) {
		if (row[kKeysAsStrings].indexOf(key) !== -1) return {
			writable: true,
			enumerable: true,
			configurable: true
		};
...
//#endregion
//#region node_modules/apache-arrow/util/vector.mjs
/** @ignore */
var tmp;
/** @ignore */
...
function createElementComparator(search) {
	...
	if (ArrayBuffer.isView(search)) return (value) => value ? compareArrayLike(search, value) : false;
...
//#endregion
//#region node_modules/apache-arrow/util/bit.mjs
/** @ignore */
...
var Data = class Data {
	...
	get nullable() {
		if (this._nullCount !== 0) {
			const { type } = this;
			if (DataType.isSparseUnion(type)) return this.children.some((child) => child.nullable);
	...
	get nullCount() {
		if (DataType.isUnion(this.type)) return this.children.reduce((nullCount, child) => nullCount + child.nullCount, 0);
		let nullCount = this._nullCount;
		let nullBitmap;
		if (nullCount <= -1 && (nullBitmap = this.nullBitmap)) this._nullCount = nullCount = nullBitmap.length === 0 ? 0 : this.length - popcnt_bit_range(nullBitmap, this.offset, this.offset + this.length);
		return nullCount;
	}
	...
	_changeLengthAndBackfillNullBitmap(newLength) {
		if (this.typeId === Type.Null) return this.clone(this.type, 0, newLength, 0);
		const { length, nullCount } = this;
		const bitmap = new Uint8Array((newLength + 63 & -64) >> 3).fill(255, 0, length >> 3);
		bitmap[length >> 3] = (1 << length - (length & -8)) - 1;
		if (nullCount > 0) bitmap.set(truncateBitmap(this.offset, length, this.nullBitmap), 0);
...
var makeDataVisitor = new class MakeDataVisitor extends Visitor {
	visit(props) {
	...
	visitUnion(props) {
		...
		if (DataType.isSparseUnion(type)) return new Data(type, offset, length, nullCount, [
			void 0,
			void 0,
			void 0,
			typeIds
		...
		return new Data(type, offset, length, nullCount, [
			toInt32Array(props["valueOffsets"]),
			void 0,
			void 0,
			typeIds
		], children);
...
//#endregion
//#region node_modules/apache-arrow/util/chunk.mjs
/** @ignore */
...
//#endregion
//#region node_modules/apache-arrow/visitor/indexof.mjs
/** @ignore */
...
function indexOfValue(data, searchElement, fromIndex) {
	...
	if (searchElement === null) switch (data.typeId) {
		case Type.Union: break;
		case Type.Dictionary: break;
...
/** @ignore */
var instance$4 = new IndexOfVisitor();
//#endregion
//#region node_modules/apache-arrow/visitor/iterator.mjs
/** @ignore */
var IteratorVisitor = class extends Visitor {};
/** @ignore */
function vectorIterator(vector) {
	const { type } = vector;
	if (vector.nullCount === 0 && vector.stride === 1 && (DataType.isInt(type) && type.bitWidth !== 64 || DataType.isTime(type) && type.bitWidth !== 64 || DataType.isFloat(type) && type.precision !== Precision.HALF)) return new ChunkedIterator(vector.data.length, (chunkIndex) => {
...
/** @ignore */
var instance$3 = new IteratorVisitor();
//#endregion
//#region node_modules/apache-arrow/vector.mjs
var _a$2;
...
var Vector = class Vector {
	constructor(input) {
		...
		if (data.length === 0 || data.some((x) => !(x instanceof Data))) throw new TypeError("Vector constructor expects an Array of Data instances.");
	...
	*/
	toArray() {
		...
		switch (type.typeId) {
			...
			case Type.Decimal:
			case Type.Time:
			case Type.Timestamp: switch (data.length) {
	...
	*/
	...
	get isMemoized() {
		if (DataType.isDictionary(this.type)) return this.data[0].dictionary.isMemoized;
		return false;
	}
	/**
...
Vector[_a$2] = ((proto) => {
	...
	for (const typeId of typeIds) {
		visitorsByTypeId[typeId] = {
			get: instance$5.getVisitFnByTypeId(typeId),
			set: instance$6.getVisitFnByTypeId(typeId),
			indexOf: instance$4.getVisitFnByTypeId(typeId)
		};
...
//#endregion
//#region node_modules/apache-arrow/builder/valid.mjs
/**
...
function valueToCase(x) {
	if (typeof x !== "bigint") return valueToString(x);
	return `${valueToString(x)}n`;
}
//#endregion
//#region node_modules/apache-arrow/builder/buffer.mjs
/** @ignore */
...
//#endregion
//#region node_modules/apache-arrow/builder.mjs
/**
	...
	*/
	constructor({ "type": type, "nullValues": nulls }) {
		...
		*/
		...
		if (nulls && nulls.length > 0) this._isValid = createIsValidFunction(nulls);
	}
	/**
...
/** @ignore */
var FixedWidthBuilder = class extends Builder$2 {
	constructor(opts) {
		super(opts);
...
/** @ignore */
var VariableWidthBuilder = class extends Builder$2 {
	constructor(opts) {
		super(opts);
...
//#endregion
//#region node_modules/apache-arrow/fb/block.mjs
var Block = class {
	constructor() {
		this.bb = null;
		this.bb_pos = 0;
...
//#endregion
//#region node_modules/apache-arrow/fb/footer.mjs
/**
* ----------------------------------------------------------------------
* Arrow File metadata
*
...
//#endregion
//#region node_modules/apache-arrow/ipc/metadata/file.mjs
...
var Footer_ = class {
	...
	static decode(buf) {
		...
		return new OffHeapFooter(Schema.decode(footer.schema(), /* @__PURE__ */ new Map(), footer.version()), footer);
	}
	/** @nocollapse */
...
//#endregion
//#region node_modules/apache-arrow/io/interfaces.mjs
/** @ignore */
...
var AsyncQueue = class extends ReadableInterop {
	...
	close() {
		if (this._closedPromiseResolve) {
			...
			while (resolvers.length > 0) resolvers.shift().resolve(ITERATOR_DONE);
	...
	next(..._args) {
		...
		else if (!this._closedPromiseResolve) return Promise.resolve(ITERATOR_DONE);
...
//#endregion
//#region node_modules/apache-arrow/io/stream.mjs
/** @ignore */
var AsyncByteQueue = class extends AsyncQueue {
	write(value) {
		if ((value = toUint8Array(value)).byteLength > 0) return super.write(value);
	}
	toString(sync = false) {
...
var ByteStream = class {
	constructor(source) {
		if (source) this.source = new ByteStreamSource(adapters_default.fromIterable(source));
	}
	[Symbol.iterator]() {
		return this;
	}
...
/** @ignore */
var AsyncByteStream = class AsyncByteStream {
	constructor(source) {
		if (source instanceof AsyncByteStream) this.source = source.source;
		else if (source instanceof AsyncByteQueue) this.source = new AsyncByteStreamSource(adapters_default.fromAsyncIterable(source));
		else if (isReadableNodeStream(source)) this.source = new AsyncByteStreamSource(adapters_default.fromNodeStream(source));
		else if (isReadableDOMStream(source)) this.source = new AsyncByteStreamSource(adapters_default.fromDOMStream(source));
		else if (isFetchResponse(source)) this.source = new AsyncByteStreamSource(adapters_default.fromDOMStream(source.body));
		else if (isIterable(source)) this.source = new AsyncByteStreamSource(adapters_default.fromIterable(source));
		else if (isPromise(source)) this.source = new AsyncByteStreamSource(adapters_default.fromAsyncIterable(source));
		else if (isAsyncIterable(source)) this.source = new AsyncByteStreamSource(adapters_default.fromAsyncIterable(source));
	}
	[Symbol.asyncIterator]() {
		return this;
	}
...
//#endregion
//#region node_modules/apache-arrow/io/file.mjs
/** @ignore */
...
var AsyncRandomAccessFile = class extends AsyncByteStream {
	constructor(file, byteLength) {
		...
		else this._pending = __awaiter(this, void 0, void 0, function* () {
...
//#endregion
//#region node_modules/apache-arrow/util/int.mjs
/** @ignore */
...
//#endregion
//#region node_modules/apache-arrow/visitor/vectorloader.mjs
/** @ignore */
var VectorLoader = class extends Visitor {
	...
	visitUnion(type, { length, nullCount } = this.nextFieldNode()) {
		if (this.metadataVersion < MetadataVersion.V5) this.readNullBitmap(type, nullCount);
		return type.mode === UnionMode.Sparse ? this.visitSparseUnion(type, {
			length,
			nullCount
...
var JSONVectorLoader = class extends VectorLoader {
	...
	readData(type, { offset } = this.nextBufferRange()) {
		const { sources } = this;
		if (DataType.isTimestamp(type)) return toArrayBufferView(Uint8Array, Int64.convertArray(sources[offset]));
		else if ((DataType.isInt(type) || DataType.isTime(type)) && type.bitWidth === 64 || DataType.isDuration(type)) return toArrayBufferView(Uint8Array, Int64.convertArray(sources[offset]));
		...
		else if (DataType.isBinary(type) || DataType.isLargeBinary(type) || DataType.isFixedSizeBinary(type)) return binaryDataFromJSON(sources[offset]);
		else if (DataType.isBool(type)) return packBools(sources[offset]);
		else if (DataType.isUtf8(type) || DataType.isLargeUtf8(type)) return encodeUtf8(sources[offset].join(""));
...
//#endregion
//#region node_modules/apache-arrow/builder/binary.mjs
/** @ignore */
...
//#endregion
//#region node_modules/apache-arrow/builder/largebinary.mjs
/** @ignore */
...
//#endregion
//#region node_modules/apache-arrow/builder/bool.mjs
/** @ignore */
var BoolBuilder = class extends Builder$2 {
	constructor(options) {
		super(options);
...
//#endregion
//#region node_modules/apache-arrow/builder/date.mjs
/** @ignore */
...
//#endregion
//#region node_modules/apache-arrow/builder/decimal.mjs
/** @ignore */
var DecimalBuilder = class extends FixedWidthBuilder {};
DecimalBuilder.prototype._setValue = setDecimal;
//#endregion
//#region node_modules/apache-arrow/builder/dictionary.mjs
/** @ignore */
var DictionaryBuilder = class extends Builder$2 {
...
//#endregion
//#region node_modules/apache-arrow/builder/fixedsizebinary.mjs
/** @ignore */
var FixedSizeBinaryBuilder = class extends FixedWidthBuilder {};
FixedSizeBinaryBuilder.prototype._setValue = setFixedSizeBinary;
//#endregion
//#region node_modules/apache-arrow/builder/fixedsizelist.mjs
/** @ignore */
var FixedSizeListBuilder = class extends Builder$2 {
	setValue(index, value) {
...
//#endregion
//#region node_modules/apache-arrow/builder/float.mjs
/** @ignore */
...
//#endregion
//#region node_modules/apache-arrow/builder/interval.mjs
/** @ignore */
...
//#endregion
//#region node_modules/apache-arrow/builder/duration.mjs
/** @ignore */
...
//#endregion
//#region node_modules/apache-arrow/builder/int.mjs
/** @ignore */
...
//#endregion
//#region node_modules/apache-arrow/builder/list.mjs
/** @ignore */
...
//#endregion
//#region node_modules/apache-arrow/builder/map.mjs
/** @ignore */
...
//#endregion
//#region node_modules/apache-arrow/builder/null.mjs
/** @ignore */
var NullBuilder = class extends Builder$2 {
	setValue(index, value) {}
	setValid(index, valid) {
...
//#endregion
//#region node_modules/apache-arrow/builder/struct.mjs
/** @ignore */
var StructBuilder = class extends Builder$2 {
	setValue(index, value) {
...
//#endregion
//#region node_modules/apache-arrow/builder/timestamp.mjs
/** @ignore */
...
//#endregion
//#region node_modules/apache-arrow/builder/time.mjs
/** @ignore */
...
//#endregion
//#region node_modules/apache-arrow/builder/union.mjs
/** @ignore */
var UnionBuilder = class extends Builder$2 {
	constructor(options) {
		super(options);
...
//#endregion
//#region node_modules/apache-arrow/builder/utf8.mjs
/** @ignore */
...
//#endregion
//#region node_modules/apache-arrow/builder/largeutf8.mjs
/** @ignore */
...
//#endregion
//#region node_modules/apache-arrow/visitor/builderctor.mjs
/** @ignore */
...
/** @ignore */
var instance$2 = new GetBuilderCtor();
//#endregion
//#region node_modules/apache-arrow/visitor/typecomparator.mjs
/** @ignore */
...
/** @ignore */
var instance$1 = new TypeComparator();
function compareSchemas(schema, other) {
	return instance$1.compareSchemas(schema, other);
}
//#endregion
//#region node_modules/apache-arrow/factories.mjs
...
//#endregion
//#region node_modules/apache-arrow/util/recordbatch.mjs
/** @ignore */
...
function uniformlyDistributeChunksAcrossRecordBatches(schema, cols) {
	...
	while (memo.numBatches-- > 0) {
		...
		if (Number.isFinite(batchLength)) {
			...
			if (batchLength > 0) batches[numBatches++] = makeData({
	...
	return [schema = schema.assign(fields), batches.map((data) => new RecordBatch$1(schema, data))];
}
/** @ignore */
...
//#endregion
//#region node_modules/apache-arrow/table.mjs
var _a$1;
/**
...
var Table = class Table {
	constructor(...args) {
		...
		const unwrap = (x) => {
			if (x) {
				if (x instanceof RecordBatch$1) return [x];
				else if (x instanceof Table) return x.batches;
				else if (x instanceof Data) {
					if (x.type instanceof Struct) return [new RecordBatch$1(new Schema(x.type.children), x)];
					...
					const [, batches] = distributeVectorsIntoRecordBatches(schema !== null && schema !== void 0 ? schema : new Schema(keys.map((k, i) => new Field(String(k), vecs[i].type, vecs[i].nullable))), vecs);
		...
		if (!(schema instanceof Schema)) throw new TypeError("Table constructor expects a [Schema, RecordBatch[]] pair.");
		for (const batch of batches) {
			if (!(batch instanceof RecordBatch$1)) throw new TypeError("Table constructor expects a [Schema, RecordBatch[]] pair.");
			if (!compareSchemas(schema, batch.schema)) throw new TypeError("Table and inner RecordBatch schemas must be equivalent.");
		}
		this.schema = schema;
	...
	*/
	get nullCount() {
		if (this._nullCount === -1) this._nullCount = computeChunkNullCounts(this.data);
	...
	*/
	[Symbol.iterator]() {
		if (this.batches.length > 0) return instance$3.visit(new Vector(this.data));
	...
	*/
	concat(...others) {
		...
		return new Table(schema, this.data.concat(others.flatMap(({ data }) => data)).map((data) => new RecordBatch$1(schema, data)));
	}
	/**
	...
	*/
	slice(begin, end) {
		...
		return new Table(schema, sliceChunks(this.data, this._offsets, begin, end).map((chunk) => new RecordBatch$1(schema, chunk)));
	}
	/**
	* Returns a child Vector by name, or null if this Vector has no child with the given name.
	*
	...
	*/
	...
	setChildAt(index, child) {
		...
		if (index > -1 && index < this.numCols) {
			if (!child) child = new Vector([makeData({
				type: new Null(),
				length: this.numRows
			})]);
	...
	*/
	...
	assign(other) {
		...
		return new Table(...distributeVectorsIntoRecordBatches(this.schema.assign(other.schema), [...fields.map((_, i) => [i, oldToNew[i]]).map(([i, j]) => j === void 0 ? this.getChildAt(i) : other.getChildAt(j)), ...indices.map((i) => other.getChildAt(i))].filter(Boolean)));
	}
};
...
//#endregion
//#region node_modules/apache-arrow/recordbatch.mjs
var _a;
/** @ignore */
var RecordBatch$1 = class RecordBatch$1 {
	constructor(...args) {
		switch (args.length) {
			case 2:
				[this.schema] = args;
				if (!(this.schema instanceof Schema)) throw new TypeError("RecordBatch constructor expects a [Schema, Data] pair.");
				[, this.data = makeData({
					nullCount: 0,
				...
				if (!(this.data instanceof Data)) throw new TypeError("RecordBatch constructor expects a [Schema, Data] pair.");
	...
	*/
	slice(begin, end) {
		...
		return new RecordBatch$1(this.schema, slice);
	}
	/**
	* Returns a child Vector by name, or null if this Vector has no child with the given name.
	* @param name The name of the child to retrieve.
	...
	*/
	getChildAt(index) {
		if (index > -1 && index < this.schema.fields.length) return new Vector([this.data.children[index]]);
		return null;
	}
	/**
	* Sets a child Vector by name.
	...
	*/
	...
	setChildAt(index, child) {
		...
		return new RecordBatch$1(schema, data);
	}
	/**
	...
	*/
	select(columnNames) {
		...
		return new RecordBatch$1(schema, makeData({
			type,
			length: this.numRows,
			children
		}));
...
* @private
*/
var _InternalEmptyPlaceholderRecordBatch = class extends RecordBatch$1 {
	constructor(schema) {
...
//#endregion
//#region node_modules/apache-arrow/fb/message.mjs
var Message$1 = class Message$1 {
	constructor() {
		this.bb = null;
		this.bb_pos = 0;
	}
...
//#endregion
//#region node_modules/apache-arrow/visitor/typeassembler.mjs
/** @ignore */
var TypeAssembler = class extends Visitor {
	...
	visitTimestamp(node, b) {
		...
		if (timezone !== void 0) Timestamp.addTimezone(b, timezone);
	...
	visitDictionary(node, b) {
		...
		if (indexType !== void 0) DictionaryEncoding.addIndexType(b, indexType);
...
/** @ignore */
var instance = new TypeAssembler();
//#endregion
//#region node_modules/apache-arrow/ipc/metadata/json.mjs
/** @ignore */
...
function typeFromJSON(f, children) {
	...
	switch (typeId) {
		...
		case "union": {
			...
			return new Union_(UnionMode[m.toUpperCase() + ms.join("")], t["typeIds"] || [], children || []);
		}
...
//#endregion
//#region node_modules/apache-arrow/ipc/metadata/message.mjs
...
var Message = class Message {
	...
	static encode(message) {
		const b = new Builder();
		let headerOffset = -1;
		if (message.isSchema()) headerOffset = Schema.encode(b, message.header());
	...
	static from(header, bodyLength = 0) {
		if (header instanceof Schema) return new Message(0, MetadataVersion.V5, MessageHeader.Schema, header);
		if (header instanceof RecordBatch) return new Message(bodyLength, MetadataVersion.V5, MessageHeader.RecordBatch, header);
		if (header instanceof DictionaryBatch) return new Message(bodyLength, MetadataVersion.V5, MessageHeader.DictionaryBatch, header);
...
function decodeMessageHeader(message, type) {
	return (() => {
		switch (type) {
			case MessageHeader.Schema: return Schema.decode(message.header(new Schema$1()), /* @__PURE__ */ new Map(), message.version());
...
function decodeSchema(_schema, dictionaries = /* @__PURE__ */ new Map(), version = MetadataVersion.V5) {
	return new Schema(decodeSchemaFields(_schema, dictionaries), decodeCustomMetadata(_schema), dictionaries, version);
}
/** @ignore */
...
function decodeBuffers(batch, version) {
	...
	for (let b, i = -1, j = -1, n = batch.buffersLength(); ++i < n;) if (b = batch.buffers(i)) {
		if (version < MetadataVersion.V4) b.bb_pos += 8 * (i + 1);
...
function decodeSchemaFields(schema, dictionaries) {
	const fields = [];
	for (let f, i = -1, j = -1, n = schema.fieldsLength(); ++i < n;) if (f = schema.fields(i)) fields[++j] = Field.decode(f, dictionaries);
	return fields;
}
/** @ignore */
function decodeFieldChildren(field, dictionaries) {
	const children = [];
	for (let f, i = -1, j = -1, n = field.childrenLength(); ++i < n;) if (f = field.children(i)) children[++j] = Field.decode(f, dictionaries);
	return children;
}
/** @ignore */
...
function decodeFieldType(f, children) {
	...
	switch (typeId) {
		...
		case Type$1["FloatingPoint"]: return new Float(f.type(new FloatingPoint()).precision());
		case Type$1["Decimal"]: {
			const t = f.type(new Decimal$1());
			return new Decimal(t.scale(), t.precision(), t.bitWidth());
		}
		case Type$1["Date"]: return new Date_(f.type(new Date$1()).unit());
		case Type$1["Time"]: {
		...
		case Type$1["Interval"]: return new Interval_(f.type(new Interval()).unit());
		case Type$1["Duration"]: return new Duration(f.type(new Duration$1()).unit());
		case Type$1["Union"]: {
			const t = f.type(new Union());
			return new Union_(t.mode(), t.typeIdsArray() || [], children || []);
		}
		case Type$1["FixedSizeBinary"]: return new FixedSizeBinary(f.type(new FixedSizeBinary$1()).byteWidth());
		case Type$1["FixedSizeList"]: return new FixedSizeList(f.type(new FixedSizeList$1()).listSize(), (children || [])[0]);
		case Type$1["Map"]: {
...
function encodeSchema(b, schema) {
	...
	if (metadataOffset !== -1) Schema$1.addCustomMetadata(b, metadataOffset);
...
function encodeField(b, field) {
	...
	if (!DataType.isDictionary(type)) typeOffset = instance.visit(type, b);
	else {
	...
	if (nameOffset !== -1) Field$1.addName(b, nameOffset);
	if (dictionaryOffset !== -1) Field$1.addDictionary(b, dictionaryOffset);
	if (metadataOffset !== -1) Field$1.addCustomMetadata(b, metadataOffset);
...
//#endregion
//#region node_modules/apache-arrow/ipc/message.mjs
/** @ignore */ var invalidMessageType = (type) => `Expected ${MessageHeader[type]} Message in stream, but was null or length 0.`;
/** @ignore */ var nullMessage = (type) => `Header pointer of flatbuffer-encoded ${MessageHeader[type]} Message is null or length 0.`;
...
var MessageReader = class {
	...
	next() {
		...
		if (r.value === -1 && (r = this.readMetadataLength()).done) return ITERATOR_DONE;
...
var AsyncMessageReader = class {
	...
	next() {
		return __awaiter(this, void 0, void 0, function* () {
			let r;
			if ((r = yield this.readMetadataLength()).done) return ITERATOR_DONE;
			if (r.value === -1 && (r = yield this.readMetadataLength()).done) return ITERATOR_DONE;
			if ((r = yield this.readMetadata(r.value)).done) return ITERATOR_DONE;
			return r;
		});
	}
	throw(value) {
	...
	readMetadataLength() {
		return __awaiter(this, void 0, void 0, function* () {
			const buf = yield this.source.read(4);
			const bb = buf && new ByteBuffer$2(buf);
			const len = (bb === null || bb === void 0 ? void 0 : bb.readInt32(0)) || 0;
			return {
				done: len === 0,
	...
	next() {
		...
		if (!this._schema) {
			...
			return {
				...
				value: Message.fromJSON(_json.schema, MessageHeader.Schema)
			};
		}
		if (this._dictionaryIndex < _json.dictionaries.length) {
			...
			return {
				...
				value: Message.fromJSON(batch, MessageHeader.DictionaryBatch)
			};
		}
		if (this._batchIndex < _json.batches.length) {
			...
			return {
				...
				value: Message.fromJSON(batch, MessageHeader.RecordBatch)
			};
		}
		this._body = [];
		return ITERATOR_DONE;
...
/** @ignore */
var MAGIC = new Uint8Array(6);
for (let i = 0; i < 6; i += 1) MAGIC[i] = MAGIC_STR.codePointAt(i);
/** @ignore */
function checkForMagicArrowString(buffer, index = 0) {
	for (let i = -1, n = MAGIC.length; ++i < n;) if (MAGIC[i] !== buffer[index + i]) return false;
	return true;
}
/** @ignore */
var magicLength = MAGIC.length;
/** @ignore */
var magicAndPadding = magicLength + 4;
/** @ignore */
var magicX2AndPadding = magicLength * 2 + 4;
//#endregion
//#region node_modules/apache-arrow/ipc/reader.mjs
var RecordBatchReader = class RecordBatchReader extends ReadableInterop {
	constructor(impl) {
		super();
		this._impl = impl;
	}
	...
	static from(source) {
		...
		else if (isArrowJSON(source)) return fromArrowJSON(source);
		else if (isFileHandle(source)) return fromFileHandle(source);
		else if (isPromise(source)) return __awaiter(this, void 0, void 0, function* () {
			return yield RecordBatchReader.from(yield source);
		});
		else if (isFetchResponse(source) || isReadableDOMStream(source) || isReadableNodeStream(source) || isAsyncIterable(source)) return fromAsyncByteStream(new AsyncByteStream(source));
		return fromByteStream(new ByteStream(source));
	}
	/** @nocollapse */
	static readAll(source) {
		if (source instanceof RecordBatchReader) return source.isSync() ? readAllSync(source) : readAllAsync(source);
		else if (isArrowJSON(source) || ArrayBuffer.isView(source) || isIterable(source) || isIteratorResult(source)) return readAllSync(source);
...
function readAllAsync(source) {
	return __asyncGenerator(this, arguments, function* readAllAsync_1() {
		...
		try {
			if (!(yield __await(reader.open({ autoDestroy: false }))).closed) do
...
function fromFileHandle(source) {
	return __awaiter(this, void 0, void 0, function* () {
		...
		if (size >= magicX2AndPadding && checkForMagicArrowString(yield file.readAt(0, magicLength + 7 & -8))) return new AsyncRecordBatchFileReader(new AsyncRecordBatchFileReaderImpl(file));
		return new AsyncRecordBatchStreamReader(new AsyncRecordBatchStreamReaderImpl(file));
	});
}
//#endregion
//#region node_modules/apache-arrow/visitor/vectorassembler.mjs
/** @ignore */
var VectorAssembler = class VectorAssembler extends Visitor {
	/** @nocollapse */
 ...
 /* istanbul ignore next */
			...
			if (DataType.isUnion(type)) this.nodes.push(new FieldNode(length, 0));
			else {
				const { nullCount } = data;
				if (!DataType.isNull(type)) addBuffer.call(this, nullCount <= 0 ? new Uint8Array(0) : truncateBitmap(data.offset, length, data.nullBitmap));
...
function assembleUnion(data) {
	...
	if (type.mode === UnionMode.Sparse) return assembleNestedVector.call(this, data);
	else if (type.mode === UnionMode.Dense) if (data.offset <= 0) {
...
function assembleBoolVector(data) {
	...
	else if ((values = data.values) instanceof Uint8Array) return addBuffer.call(this, truncateBitmap(data.offset, data.length, values));
	/* istanbul ignore next */
...
//#endregion
//#region node_modules/apache-arrow/ipc/writer.mjs
var RecordBatchWriter = class extends ReadableInterop {
	...
	writeAll(input) {
		if (isPromise(input)) return input.then((x) => this.writeAll(x));
		else if (isAsyncIterable(input)) return writeAllAsync(this, input);
	...
	reset(sink = this._sink, schema = null) {
		if (sink === this._sink || sink instanceof AsyncByteQueue) this._sink = sink;
		else {
			this._sink = new AsyncByteQueue();
			if (sink && isWritableDOMStream(sink)) this.toDOMStream({ type: "bytes" }).pipeTo(sink);
			else if (sink && isWritableNodeStream(sink)) this.toNodeStream({ objectMode: false }).pipe(sink);
		}
		...
		this._seenDictionaries = /* @__PURE__ */ new Map();
		this._dictionaryDeltaOffsets = /* @__PURE__ */ new Map();
		if (!schema || !compareSchemas(schema, this._schema)) if (schema == null) {
			this._position = 0;
			this._schema = null;
		} else {
			this._started = true;
	...
	write(payload) {
		...
		else if (payload instanceof Table && !(schema = payload.schema)) return this.finish() && void 0;
		else if (payload instanceof RecordBatch$1 && !(schema = payload.schema)) return this.finish() && void 0;
		if (schema && !compareSchemas(schema, this._schema)) {
			if (this._started && this._autoDestroy) return this.close();
			this.reset(this._sink, schema);
		}
		if (payload instanceof RecordBatch$1) {
			if (!(payload instanceof _InternalEmptyPlaceholderRecordBatch)) this._writeRecordBatch(payload);
		} else if (payload instanceof Table) this.writeAll(payload.batches);
		else if (isIterable(payload)) this.writeAll(payload);
	}
	_writeMessage(message, alignment = 8) {
		...
		if (message.headerType === MessageHeader.RecordBatch) this._recordBatchBlocks.push(new FileBlock(alignedSize, message.bodyLength, this._position));
		else if (message.headerType === MessageHeader.DictionaryBatch) this._dictionaryBlocks.push(new FileBlock(alignedSize, message.bodyLength, this._position));
	...
	_writeDictionaryBatch(dictionary, id, isDelta = false) {
		...
		const dictionaryBatch = new DictionaryBatch(new RecordBatch(dictionary.length, nodes, bufferRegions), id, isDelta);
...
/** @ignore */
var RecordBatchStreamWriter = class RecordBatchStreamWriter extends RecordBatchWriter {
	/** @nocollapse */
	static writeAll(input, options) {
		const writer = new RecordBatchStreamWriter(options);
		if (isPromise(input)) return input.then((x) => writer.writeAll(x));
		else if (isAsyncIterable(input)) return writeAllAsync(writer, input);
		return writeAll(writer, input);
	}
};
/** @ignore */
var RecordBatchFileWriter = class RecordBatchFileWriter extends RecordBatchWriter {
	/** @nocollapse */
...
//#endregion
//#region node_modules/apache-arrow/io/whatwg/iterable.mjs
/** @ignore */
...
function iterableAsReadableDOMStream(source, options) {
	...
	return new ReadableStream(Object.assign(Object.assign({}, options), {
		...
		cancel() {
			!(it === null || it === void 0) && it.return && it.return(), it = null;
		}
...
function asyncIterableAsReadableDOMStream(source, options) {
	...
	return new ReadableStream(Object.assign(Object.assign({}, options), {
		...
		cancel() {
			return __awaiter(this, void 0, void 0, function* () {
				!(it === null || it === void 0) && it.return && (yield it.return()), it = null;
			});
		}
	}), Object.assign({ highWaterMark: bm ? hwm : void 0 }, options));
	function next(controller, it) {
...
//#endregion
//#region node_modules/apache-arrow/io/whatwg/builder.mjs
/** @ignore */
...
var BuilderTransform = class {
	constructor(options) {
		...
		const { ["readableStrategy"]: readableStrategy, ["writableStrategy"]: writableStrategy, ["queueingStrategy"]: queueingStrategy = "count" } = options, builderOptions = __rest(options, [
			"readableStrategy",
			"writableStrategy",
			"queueingStrategy"
		]);
...
//#endregion
//#region node_modules/apache-arrow/io/whatwg/reader.mjs
/** @ignore */
...
//#endregion
//#region node_modules/apache-arrow/io/whatwg/writer.mjs
/** @ignore */
...
//#endregion
//#region node_modules/apache-arrow/ipc/serialization.mjs
/**
...
//#endregion
//#region node_modules/apache-arrow/Arrow.dom.mjs
...
//#endregion
//#region node_modules/@duckdb/duckdb-wasm/dist/duckdb-browser.mjs
var j = Object.create;
...
var $ = (s, e, r, t) => {
	if (e && typeof e == "object" || typeof e == "function") for (let o of V(e)) !J.call(s, o) && o !== r && P(s, o, {
		get: () => e[o],
		enumerable: !(t = K(e, o)) || t.enumerable
	});
	return s;
};
var Z = (s, e, r) => (r = s != null ? j(z(s)) : {}, $(e || !s || !s.__esModule ? P(r, "default", {
	value: s,
	enumerable: !0
}) : r, s));
var q = X((Ze, H) => {
...
function ke(s) {
	switch (s) {
		case 0: return "NONE";
		case 1: return "WEB WORKER";
		case 2: return "NODE WORKER";
		case 3: return "DUCKDB BINDINGS";
		case 4: return "DUCKDB";
		default: return "?";
	}
}
...
var E = class {
	...
	constructor(e, r, t) {
		...
		this.conn = r;
		this.header = t;
		this._first = !0, this._depleted = !1, this._inFlight = null;
	}
	async next() {
		if (this._first) return this._first = !1, {
			done: !1,
			value: this.header
		};
		...
		return this._depleted = e.length == 0, this._depleted || (this._inFlight = this.db.fetchQueryResults(this.conn)), {
			done: this._depleted,
			value: e
		};
	}
...
function _(s) {
	switch (s.typeId) {
		case Type.Binary: return { sqlType: "binary" };
		case Type.Bool: return { sqlType: "bool" };
		case Type.Date: return { sqlType: "date" };
		case Type.DateDay: return { sqlType: "date32[d]" };
		case Type.DateMillisecond: return { sqlType: "date64[ms]" };
		case Type.Decimal: {
			let e = s;
			return {
				sqlType: "decimal",
		...
		case Type.Float: return { sqlType: "float" };
		case Type.Float16: return { sqlType: "float16" };
		case Type.Float32: return { sqlType: "float32" };
		case Type.Float64: return { sqlType: "float64" };
		case Type.Int: return { sqlType: "int32" };
		case Type.Int16: return { sqlType: "int16" };
		case Type.Int32: return { sqlType: "int32" };
		case Type.Int64: return { sqlType: "int64" };
		case Type.Uint16: return { sqlType: "uint16" };
		case Type.Uint32: return { sqlType: "uint32" };
		case Type.Uint64: return { sqlType: "uint64" };
		case Type.Uint8: return { sqlType: "uint8" };
		case Type.IntervalDayTime: return { sqlType: "interval[dt]" };
		case Type.IntervalYearMonth: return { sqlType: "interval[m]" };
		case Type.List: return {
			sqlType: "list",
			valueType: _(s.valueType)
		};
		case Type.FixedSizeBinary: return {
			sqlType: "fixedsizebinary",
			byteWidth: s.byteWidth
		};
		case Type.Null: return { sqlType: "null" };
		case Type.Utf8: return { sqlType: "utf8" };
		case Type.Struct: return {
			sqlType: "struct",
		...
		case Type.Time: return { sqlType: "time[s]" };
		case Type.TimeMicrosecond: return { sqlType: "time[us]" };
		case Type.TimeMillisecond: return { sqlType: "time[ms]" };
		case Type.TimeNanosecond: return { sqlType: "time[ns]" };
		case Type.TimeSecond: return { sqlType: "time[s]" };
		case Type.Timestamp: return {
			sqlType: "timestamp",
			timezone: s.timezone || void 0
		};
		case Type.TimestampSecond: return {
			sqlType: "timestamp[s]",
			timezone: s.timezone || void 0
		};
		case Type.TimestampMicrosecond: return {
			sqlType: "timestamp[us]",
			timezone: s.timezone || void 0
		};
		case Type.TimestampNanosecond: return {
			sqlType: "timestamp[ns]",
			timezone: s.timezone || void 0
		};
		case Type.TimestampMillisecond: return {
			sqlType: "timestamp[ms]",
			timezone: s.timezone || void 0
		};
	}
...
var ce = new TextEncoder(), f = class {
	...
	async postTask(e, r = []) {
		...
		return this._pendingRequests.set(t, e), this._worker.postMessage({
			messageId: t,
			type: e.type,
			data: e.data
		}, r), await e.promise;
	...
	async startPendingQuery(e, r, t = !1) {
		if (this.shouldOPFSFileHandling()) {
	...
	async _startPendingQueryAsync(e, r, t = !1) {
		let o = new a("START_PENDING_QUERY", [
			e,
			r,
			t
		]);
	...
	async registerFileHandle(e, r, t, o) {
		let i = new a("REGISTER_FILE_HANDLE", [
			e,
			r,
			t,
			o
	...
	async insertArrowFromIPCStream(e, r, t) {
		...
		let o = new a("INSERT_ARROW_FROM_IPC_STREAM", [
			e,
			r,
			t
		]);
	...
	async insertCSVFromPath(e, r, t) {
		...
		let o = new a("IMPORT_CSV_FROM_PATH", [
			e,
			r,
			t
		]);
	...
	async insertJSONFromPath(e, r, t) {
		...
		let o = new a("IMPORT_JSON_FROM_PATH", [
			e,
			r,
			t
		]);
	...
	shouldOPFSFileHandling() {
		var e, r;
		return L((e = this.config.path) != null ? e : "") ? ((r = this.config.opfs) == null ? void 0 : r.fileHandling) == "auto" : !1;
	}
	async registerOPFSFileFromSQL(e) {
		...
		for (let o of r) try {
			...
			throw console.error(i), /* @__PURE__ */ new Error("File Not found:" + o);
		}
		return t;
	}
};
	...
	async onMessage(e) {
		switch (e.type) {
			case "PING":
				...
				return;
			case "INSTANTIATE":
				this._bindings != null && this.failWith(e, /* @__PURE__ */ new Error("duckdb already initialized"));
				try {
		...
		if (!this._bindings) return this.failWith(e, /* @__PURE__ */ new Error("duckdb is not initialized"));
		try {
			switch (e.type) {
				case "GET_VERSION":
					this.postMessage({
				...
				case "OPEN": {
					let r = e.data.path;
					r != null && r.startsWith("opfs://") && (await this._bindings.prepareDBFileHandle(r, 3), e.data.useDirectIO = !0), this._bindings.open(e.data), this.sendOK(e);
					break;
				}
				case "DROP_FILE":
				...
				case "START_PENDING_QUERY": {
					...
					r && t.push(r.buffer), this.postMessage({
						messageId: this._nextMessageId++,
						requestId: e.messageId,
...
var U = async () => WebAssembly.validate(new Uint8Array([
	0,
	97,
	115,
	109,
	...
	0,
	11
])), W = async () => WebAssembly.validate(new Uint8Array([
	0,
	97,
	115,
	109,
...
var v = async () => WebAssembly.validate(new Uint8Array([
	0,
	97,
	115,
	109,
...
var m = {
	...
	dependencies: { "apache-arrow": "^17.0.0" },
	devDependencies: {
...
var M = m.name, G = m.version, I = m.version.split("."), He = I[0], qe = I[1], Ye = I[2];
var x = () => typeof navigator > "u", Q = () => x() ? "node" : navigator.userAgent, Ve = () => Q().includes("Firefox"), ze = () => /^((?!chrome|android).)*safari/i.test(Q());
function Je() {
...
async function pe() {
	return k ??= typeof BigInt64Array < "u", y ??= await W(), g ??= await B(), S ??= await v(), h ??= await U(), {
		bigInt64Array: k,
		crossOriginIsolated: x() || globalThis.crossOriginIsolated || !1,
		wasmExceptions: y,
		wasmSIMD: S,
		wasmThreads: g,
		wasmBulkMemory: h
...
async function Xe(s) {
	let e = await pe();
	if (e.wasmExceptions) {
		if (e.wasmSIMD && e.wasmThreads && e.crossOriginIsolated && s.coi) return {
